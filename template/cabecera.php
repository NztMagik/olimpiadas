...
<html lang="en">
    ...
    <nav class="navbar navbar-expand navbar-light bg-light">
                    <div class="nav navbar-nav">
                        ...
                        <a class="nav-item nav-link" href="vista_pendientes.php">Pendientes</a>
                        <a class="nav-item nav-link" href="vista_facturas.php">Facturas</a>
                        <a class="nav-item nav-link" href="vista_productos.php">Productos</a>
